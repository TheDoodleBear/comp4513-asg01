         ...
         <div className="h-[400px] w-[700px] bg-[#279AF1] rounded-xl">
            <form className='grid w-full h-full place-items-center'>
               ...
               <div>
                  ...
                  <input type='text' className=" ml-3 w-[400px] h-[35px]" onChange={handleChange}></input>
               </div>
               <div>
                  <Link to='/moviebrowser'>
                     <button className="bg-[#4C5760] hover:bg-[#A59E8C] text-white font-bold py-2 px-4 border border-blue-700 rounded mr-3" onClick={showMatchMovies}>Show Matching Movies</button>
                  </Link>
                  <Link to='/moviebrowser' >
